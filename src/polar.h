...
class POLAR {
  ...
  public: // public member functions
    // constructor
    POLAR(uint32_t info_length, uint32_t code_length,
    ...
    // SCL decoder
    std::vector<bool> scl_decoder(std::vector<double> *llr, std::vector<bool> crc_g,
                                  unsigned nL);
    // rate matching
